...
function calcPos(currentNodes) {
  ...
  } while (validPos == false && tries != 100);
...
function createNodes() {
  ...
  for (i = 0; i < matrix.length; i++) {
    ...
    //     let upperbound_x = x + radius + padding;
    //     console.log("uB_x: " + upperbound_x);
    //     let lowerbound_x = x - radius - padding;
    //     console.log("lB_x: " + lowerbound_x);
    ...
    //     let upperbound_y = y + radius + padding;
    //     console.log("uB_y: " + upperbound_y);
    //     let lowerbound_y = y + radius + padding;
    //     console.log("lB_y: " + lowerbound_y);
